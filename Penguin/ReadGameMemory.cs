...
namespace Penguin
{
    ...
    class ReadGameMemory
    {
        ...
        public static void OpenProcess(String gameProcessName)
        {
            ...
            else
            {
                ...
                {
                    gameProc = procs[0];
                    gameStartAddress = gameProc.MainModule.BaseAddress;
                    gameEndAddress = IntPtr.Add(gameStartAddress, gameProc.MainModule.ModuleMemorySize);
        ...
        public static float getFloatFromByteArray(Byte[] byteArray)
        {
        ...
        public static int getInt32FromBytesByteArray(Byte[] byteArray)
        {
